...
const int S_PER_H = 3600;		// minutes in an hour
...
int main(void)
{
	...
	double mtime;				// time in seconds for on mile
	int mmin, msec;				// minutes and seconds for one mile

	printf("This program converts your time for a metric race\n");
	printf("to a time for running time a mile and to your average\n");
	printf("speed in miles per hour.\n");
	printf("Plese enter, in kilometers, the distance run.\n");
	scanf("%lf", &distk);		// %1f for type double
